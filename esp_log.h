#define CONFIG_ESP_MQTT_EVENT_QUEUE_SIZE 10
#define CONFIG_ESP_MQTT_TASK_STACK_SIZE 512
#define CONFIG_ESP_MQTT_TASK_STACK_PRIORITY 2

#define BOOTLOADER_BUILD 1
#define CONFIG_LOG_DEFAULT_LEVEL ESP_LOG_DEBUG
#define CONFIG_LOG_BOOTLOADER_LEVEL  ESP_LOG_DEBUG
